...
use teloxide::types::{InlineQueryResult, InlineQueryResultCachedAudio, InlineQueryResultCachedVideo, InlineQueryResultArticle, InputMessageContent, InputMessageContentText};
...
pub async fn handle(
    ...
    let quality = if is_audio { settings.default_audio } else { settings.default_video };
